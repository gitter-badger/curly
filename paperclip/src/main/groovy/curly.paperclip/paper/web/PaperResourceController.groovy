...
class PaperResourceController {
    ...
    @Loggable
    @RequestMapping(value = "/{item}", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE, headers = HttpHeaders.INTERNAL_V1)
    ...
    @Loggable
    @RequestMapping(value = "/owner/{item}", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE, headers = HttpHeaders.INTERNAL_V1)
    ...
    @Loggable
    @RequestMapping(value = "/{item}", method = RequestMethod.DELETE, headers = HttpHeaders.INTERNAL_V1)
    ...
    @Loggable
    @RequestMapping(method = [RequestMethod.PUT, RequestMethod.POST], headers = HttpHeaders.INTERNAL_V1)
